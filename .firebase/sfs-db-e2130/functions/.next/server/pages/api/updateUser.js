...
const UpdateUser = async (req, res)=>{
    try {
        const { uid, email, phoneNumber, displayName } = req.body;
        const userRecord = await (0,firebase_admin__WEBPACK_IMPORTED_MODULE_1__.auth)().updateUser(uid, {
            email,
            phoneNumber,
            displayName
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [151], () => (__webpack_exec__(6122)));
